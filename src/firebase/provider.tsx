...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  useEffect(() => {
    console.log("PROVIDER: auth instance =", auth);

    if (!auth) {
      // If no Auth service instance, cannot determine user state
      console.log("PROVIDER: auth is NULL");
      setUserAuthState({
        user: null,
        isUserLoading: false,
    ...
    const unsubscribe = onAuthStateChanged(
      ...
      (firebaseUser) => {
        ...
        console.log("PROVIDER: onAuthStateChanged fired");
        console.log("PROVIDER: firebaseUser =", firebaseUser);
        setUserAuthState({
          user: firebaseUser,
          isUserLoading: false,
          userError: null,
